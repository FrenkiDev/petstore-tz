...
[source,java]
include::src/test/java/endpoints/Endpoint.java[lines=7..14]
...
[source,java]
include::src/test/java/endpoints/Pet.java[lines=24..26]

Свойства для заполнения тела запроса:
[source,java]
include::src/test/java/endpoints/Pet.java[lines=28..34]

Методы:
[source,java]
include::src/test/java/endpoints/Pet.java[lines=34..67]

Xml описание bean endpoint свойства endpoint в классе Pet
[source,xml]
include::src/test/resources/endpoints/petstore.xml[lines=9..33]

xml описание bean Pet для теста с положительным результатом
[source,xml]
include::src/test/resources/datapools/pet.xml[lines=9..31]

*Тесты валидации*
[source,java]
include::src/test/java/tests/PetTest.java[lines=23..]
